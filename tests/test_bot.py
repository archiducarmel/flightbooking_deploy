...
# This class will mainly test if number of adults can be extracted as entity
class NumberPromptTest(aiounittest.AsyncTestCase):
    ...
    # This class will mainly test if start date and end date can be extracted as entities
